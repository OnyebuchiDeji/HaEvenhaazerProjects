"""
    ...
    Forward Kinematics from YouTube
"""
...
class Segment:
    ...
    def wiggle_end(self):
        ...
        self.angle = self.self_angle * sin(time)  +  self.self_angle * 0.625
...
class ForwardKinematics:
    ...
    def __init__(self, engine):
        ...
        self.engine = engine
        self.seg1 = Segment(500, 200, 100, -45);
        self.seg2 = Segment(500, 200, 100, 45, parent=self.seg1);
    ...
    def display(self):
        self.seg1.move_end()
        self.seg1.draw(self.engine.screen, width=5)
        self.seg2.draw(self.engine.screen, width=5)
