...
""" 
    ...
    In this part, a Material class was made to apply textures to the triangle rendered in the Part1.
    Part2B implements the code that enables opengl to add transparenct to what is rendered, for the cat.png image
"""
    ...
    def __init__(self):
       ...
       #3   for s=0.5, t=0, its the top, but s is at the center
        ...
        self.vertices = (
            ...
            0.0, 0.5, 00.0, 0.0, 0.0, 1.0, 0.5, 0.0
        )
