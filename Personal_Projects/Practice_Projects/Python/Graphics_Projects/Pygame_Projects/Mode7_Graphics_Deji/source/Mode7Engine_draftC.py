...
"""
    This version adds a seperate texture for the ceiling and a different one for the ceiling
"""
...
class Mode7:
    ...
    def update(self):
        ...
        self.screen_array = self.render_frame(self.floor_array, self.ceiling_array, self.screen_array, self.texture_size)
    ...
    def render_frame(floor_array, ceiling_array, screen_array, texture_size):
        ...
        for i in prange(WIDTH):
            for j in prange(HALF_HEIGHT, HEIGHT):
                ...
                ceiling_color = ( ceiling_color[0] * attenuation,
                                  ceiling_color[1] * attenuation,
                                  ceiling_color[2] * attenuation,)
