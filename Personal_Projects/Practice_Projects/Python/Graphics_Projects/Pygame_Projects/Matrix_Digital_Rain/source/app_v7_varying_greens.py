""""
    ...
    This version implements a range of values for the green channels of each symbol for a column.
    This is to give different green tints to the symbols of a column in a random way.
"""
