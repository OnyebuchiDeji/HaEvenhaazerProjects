""""
    ...
    This final version implements the blurring effect in a way that...
    it is very blurry in the start but gradually becomes less blury, and then loops...
    thereby giving a better effect as the original.
    It also adjusts the color values of the normal green katakana symbol surfaces to 40

    Note! To use the pg.font module, one mus do pg.init()
"""
...
green_katakana = [FONT.render(str(char), True, (40, randrange(160, 256), 40)) for char in katakana]
