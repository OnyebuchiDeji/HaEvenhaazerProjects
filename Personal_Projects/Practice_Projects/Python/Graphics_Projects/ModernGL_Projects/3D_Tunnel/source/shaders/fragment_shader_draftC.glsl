...
void main()
{
    ...
    */
    ...
    /*
        When run, the tinting becomes brighter the further from the center...
        this represents the length of the vector moving from the center.
        At the center, its value starts from 0 so it is black, and further out it tints to white
    */
