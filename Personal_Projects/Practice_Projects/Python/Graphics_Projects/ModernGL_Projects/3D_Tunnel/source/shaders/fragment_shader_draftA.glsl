...
void main()
{
    ...
    */
    ...
    /*
        When run, the tinting or brightening of the color represents the values of phi.
        when phi goes from 0 to 1, it goes from dark to white. While the completely white part...
        of the picture represents where phi is greater than 1, which just clamps to 1.
        WHereas, the completely black part is where phi is less than 0, which just clamps to 0
    */
