"""
    Added my own image from resources/
    Then changed it back after downloading the appropriate images
...
class App(customtkinter.CTk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        ##  The below gets the directory of this file
        current_path = os.path.dirname(os.path.realpath(__file__))
        #   But the working directory instead is needed
