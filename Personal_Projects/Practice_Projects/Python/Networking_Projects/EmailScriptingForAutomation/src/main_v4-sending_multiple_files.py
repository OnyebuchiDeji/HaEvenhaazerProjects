...
def msg_with_multiple_attachments():
    msg = EmailMessage()
    msg["From"] = SENDER
    msg["To"] = RECEIVER
    msg["Subject"] = "Want to finish Python."
    ...
    dir = "resources"
    files = ["20230129_112910.jpg", "red_diamond_heart.png"]

    for file in files:
        with open(dir + "/" + file, "rb") as fstr:
            file_data = fstr.read()
...
with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
    ...
    smtp.send_message(msg_with_multiple_attachments())
