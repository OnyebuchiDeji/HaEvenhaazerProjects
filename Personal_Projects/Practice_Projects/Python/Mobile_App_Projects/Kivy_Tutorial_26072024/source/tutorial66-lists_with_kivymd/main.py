"""
    ...
    This episode demonstrates how to implement basic List of Items with KivyMD
"""
...
class MyApp(MDApp):
    ...
    def on_list_press(self, listObj):
        # print(dir(listObj))
        for child in listObj.children:
            for child2 in child.children:
                # print(child2)
                if isinstance(child2, BoxLayout):
