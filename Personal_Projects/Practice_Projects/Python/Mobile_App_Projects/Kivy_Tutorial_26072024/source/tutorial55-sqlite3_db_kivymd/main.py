"""
    ...
    This episode demonstrates the use of the Sqlite3 and KivyMD

    Sqlite3 is not the kind used in Production. But it's useful here
...
class MyApp(MDApp):
    ...
    def build(self):
        self.title = "Sqlite3 Database With KivyMD"
    ...
    def submit_name(self):
        ...
        diplay_label_ref.text = f"Added {input_ref.text}" 
        print(input_ref.text)
    ...
    def show_records(self):
        ...
        records = c.fetchall()  #3  Returns a List of Tuples, a List of all the data in a row of the table
