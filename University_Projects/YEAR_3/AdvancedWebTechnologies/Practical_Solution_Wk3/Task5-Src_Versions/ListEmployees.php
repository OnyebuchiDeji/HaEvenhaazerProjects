        ...
        <?php
            ...
            switch ($action){
                ...
                case "u":
                    ...
                    $DB = new Database();
                    $targetId = isset($_GET['targetId']);
                    $newName = isset($_GET['employeeName']);
                    $newSalary = isset($_GET['employeeSalary']);
                    $newAge = isset($_GET['employeeAge']);
                    $newData = array(
                        "employeeName"=>$newName,
                        "employeeSalary"=>$newSalary,
                        "employeeAge"=>$newAge,
                    );
                    $out_array = $DB.UpdateRecord("employee", $newData);
                    break;
                default:
                ...
                <?php
                    ...
                    if ($stmnt->rowCount() > 0){
                        while ($row=$stmnt->fetch(PDO::FETCH_ASSOC)){
                            ...
                            echo "<th><a href='./UpdateForm.php'>Update</a></th>";
