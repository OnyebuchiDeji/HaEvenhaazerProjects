...
<!-- 
  Task3 AND 4: Site Map and Facebook Like and Share Button
 -->
<!DOCTYPE html>
<html lang="en">

<head>
  <title>Task3: Search Engine Optimizations; Sitemaps</title>
  <meta charset="UTF-8">
...
<body>
  <!-- For Facebook Like Button that likes an actual post -->
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v22.0"></script>

<h3 style="margin: 0% 0% 0% 15%">Task2: Search Engine Optimizations; Sitemaps</h3>
