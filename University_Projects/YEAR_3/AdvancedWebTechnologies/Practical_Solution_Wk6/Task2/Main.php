...
<!-- 
  Task2 Parts:
    a): Basic properties of webpage.
        Done: Added title and meta tags and content information/
    b): Usability Aspects:
        Done: added alt description to image
    c): Content:
        Added header that says 'Keele Contact Page'
        Added banner with keele image as well. 
 -->
<!DOCTYPE html>
<html lang="en">

<head>
  <title>Task2: Search Engine Optimizations</title>
  <meta charset="UTF-8">
  <meta name="description" content="Keele Contact Page, Search Engine Optimization Task">
  <meta name="keywords" content="HTML, CSS, JavaScript, Keele, Contact Page, SEO, Search Engine Optimization, Off-page, On-page">
  <meta name="author" content="Ebenezer, Ayo-Metibemu, Keele Student">
  <!-- <meta http-equiv="refresh" content="30"> Refresh Document every 30 seconds -->
  <!-- Also, viewport makes the document look far better. -->
...
<h3 style="margin: 0% 0% 0% 15%">Task2: Search Engine Optimizations</h3>
<h1 style="margin: 0% 0% 0% 15%">Keele Contact Page</h1>
<div id="banner">
  <img src="../res/Keele_Hall_Aerial_2.jpg" alt="Keele Contacts Keele Hall Image" title="Keele Hall Image">
</div>
<div id="content">
