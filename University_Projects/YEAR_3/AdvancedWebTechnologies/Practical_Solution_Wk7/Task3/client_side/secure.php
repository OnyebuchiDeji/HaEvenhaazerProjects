...
<html>
 ...
 <body>
  ...
  <ul>
    ...
    <li>
        Your Most Recent SQL Injection:<br>
        <div style="margin:0% 0% 0% 5%">
            What you tried at registration:
            <?php echo $_SESSION['first_injection'];?>
            <br/>
            What became of it:
            <?php echo $_SESSION['injection'];?>
            <br/>
            What you recently tried:
            <?php echo $_SESSION['tried_injection'];?>
            <br/>
            What became of it:
            <?php echo $_SESSION['current_injection'];?>
            <br/>
        </div>
    </li>
  </ul>
